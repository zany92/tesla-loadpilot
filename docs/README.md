...
| [`RUNBOOK_INCIDENTS.md`](RUNBOOK_INCIDENTS.md) | Operator runbook: the three lived failure modes (distrust, closed-loop yo-yo, refused start) — signatures, remedies, recovery protocol |
